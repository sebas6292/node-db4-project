...
const ingredients = [
    { ingredient_name: 'Broccoli', ingedient_unit: 'lbs'},
    { ingredient_name: 'Pesto', ingedient_unit: 'lbs'},
    { ingredient_name: 'Pasta', ingedient_unit: 'lbs'},
    { ingredient_name: 'Lemon', ingedient_unit: 'slices'},
    { ingredient_name: 'Chicken', ingedient_unit: 'kilos'},
    { ingredient_name: 'Salmon', ingedient_unit: 'grams'},
...
const steps = [
    ...
    { step_text: 'Add pesto mixed with past', step_number: 3, recipe_id: 1},
    //Lemon Chicken
